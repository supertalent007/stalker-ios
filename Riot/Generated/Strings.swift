...
public class VectorL10n: NSObject {
  ...
  /// This file contains encryption keys exported from a Stalker client.\nDo you want to view the file content or import the keys it contains?
  ...
  /// No identity server is configured so you cannot add an email address in order to reset your Stalker account password in the future.
  ...
  /// Forgot Stalker account password?
  public static var authForgotPassword: String { 
    return VectorL10n.tr("Vector", "auth_forgot_password") 
  }
  /// No identity server is configured: add one to reset your Stalker account password.
  ...
  /// No identity server is configured so you cannot add a phone number in order to reset your Stalker account password in the future.
  ...
  /// Confirm your new Stalker account password
  ...
  /// No identity server is configured: add one in server options to reset your Stalker account password.
  ...
  /// Your email address does not appear to be associated with a Stalker ID on this homeserver.
  ...
  /// To reset your Stalker account password, enter the email address linked to your account:
  ...
  /// Your Stalker account password has been reset.\n\nYou have been logged out of all sessions and will no longer receive push notifications. To re-enable notifications, re-log in on each device.
  ...
  /// Open Stalker on your other device
  ...
  /// If you would like us to forget your messages, please tick the box below\n\nMessage visibility in Stalker is similar to email. Our forgetting your messages means that messages you have sent will not be shared with any new or unregistered users, but registered users who already have access to these messages will still have access to their copy.
  ...
  /// To continue, please enter your Stalker account password
  ...
  /// This works with %@ and other cross-signing capable Stalker clients.
  ...
  /// This process allows you to export the keys for messages you have received in encrypted rooms to a local file. You will then be able to import the file into another Stalker client in the future, so that client will also be able to decrypt these messages.\nThe exported file will allow anyone who can read it to decrypt any encrypted messages that you can see, so you should be careful to keep it secure.
  ...
  /// This process allows you to import encryption keys that you had previously exported from another Stalker client. You will then be able to decrypt any messages that the other client could decrypt.\nThe export file is protected with a passphrase. You should enter the passphrase here, to decrypt the file.
  ...
  /// Malformed ID. Should be a Stalker ID like '@localpart:domain'
  ...
  /// I'd like to chat with you with Stalker. Please, visit the website http://stalkermatrix.net to have more information.
  ...
  /// To discover contacts already using Stalker, %@ can send email addresses and phone numbers in your address book to your chosen Stalker identity server. Where supported, personal data is hashed before sending - please check your identity server's privacy policy for more details.
  ...
  /// If you’d like to share your Live location, Stalker needs location access when the app is in the background.\nTo enable access, tap Settings> Location and select Always
  ...
  /// Specify an email address lets other users find you on Stalker more easily, and will give you a way to reset your password in the future.
  ...
  /// Stalker provides identity servers to track which emails etc. belong to which Stalker IDs. Only https://stalkermatrix.net currently exists.
  ...
  /// URL (e.g. https://stalkermatrix.net)
  ...
  /// Stalker ID (e.g. @bob:stalker.org or bob)
  ...
  /// Choose where your conversations are kept, giving you control and independence. Connected via Stalker.
  ...
  /// Stalker is also great for the workplace. It’s trusted by the world’s most secure organisations.
  ...
  /// Unable to find profiles for this Stalker ID. Would you like to start a DM anyway?
  ...
  /// Malformed ID. Should be an email address or a Stalker ID like '@localpart:domain'
  ...
  /// Unable to find profiles for this Stalker ID. Are you sure you want to invite %@ to %@?
  ...
  /// Enter your Stalker account password to confirm
  ...
  /// Don't use your Stalker account password.
  ...
  /// Sorry. This action is not available on %@ iOS yet. Please use another Stalker client to set it up. %@ iOS will use it.
  ...
  /// If you don’t recognise a login, change your Stalker account password and reset Secure Backup.
  ...
  /// Confirm your identity by entering your Stalker account password
  ...
  /// Fail to update Stalker account password
  ...
  /// Your Stalker account password has been updated
  ...
  /// Stalker is a new type of messenger and collaboration app that:\n\n1. Puts you in control to preserve your privacy\n2. Lets you communicate with anyone in the Stalker network, and even beyond by integrating with apps such as Slack\n3. Protects you from advertising, datamining, backdoors and walled gardens\n4. Secures you through end-to-end encryption, with cross-signing to verify others\n\nStalker is completely different from other messaging and collaboration apps because it is decentralised and open source.\n\nStalker lets you self-host - or choose a host - so that you have privacy, ownership and control of your data and conversations. It gives you access to an open network; so you’re not just stuck speaking to other Stalker users only. And it is very secure.\n\nStalker is able to do all this because it operates on Stalker - the standard for open, decentralised communication. \n\nStalker puts you in control by letting you choose who hosts your conversations. From the Stalker app, you can choose to host in different ways:\n\n1. Get a free account on the Stalker public server\n2. Self-host your account by running a server on your own hardware\n3. Sign up for an account on a custom server by simply subscribing to the Stalker Stalker Services hosting platform\n\nWhy choose Stalker?\n\nOWN YOUR DATA: You decide where to keep your data and messages. You own it and control it, not some MEGACORP that mines your data or gives access to third parties.\n\nOPEN MESSAGING AND COLLABORATION: You can chat with anyone else in the Stalker network, whether they’re using Stalker or another Stalker app, and even if they are using a different messaging system of the likes of Slack, IRC or XMPP.\n\nSUPER-SECURE: Real end-to-end encryption (only those in the conversation can decrypt messages), and cross-signing to verify the devices of conversation participants.\n\nCOMPLETE COMMUNICATION: Messaging, voice and video calls, file sharing, screen sharing and a whole bunch of integrations, bots and widgets. Build rooms, communities, stay in touch and get things done.\n\nEVERYWHERE YOU ARE: Stay in touch wherever you are with fully synchronised message history across all your devices and on the web at https://Stalker.io/app.
  ...
  /// All threads created during the experimental period will now be <b>rendered as regular replies</b>.<br/><br/>This will be a one-off transition, as threads are now part of the Stalker specification.
  ...
  /// This session doesn't support encryption, so it can't be verified.\n\nYou won't be able to participate in rooms where encryption is enabled when using this session.\n\nFor best security and privacy, it is recommended to use Stalker clients that support encryption.
  ...
  /// Verified sessions are anywhere you are using Stalker after entering your passphrase or confirming your identity with another verified session.\n\nThis means that you have all the keys needed to unlock your encrypted messages and confirm to other users that you trust this session.
